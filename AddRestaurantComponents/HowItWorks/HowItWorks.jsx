        ...
        <div className={css.innerDiv}>
            ...
            <div className={css.div2}>
                ...
                <div className={css.cards}>
                    <Card5 step='1' title='Create your page on Foodie Loverz' tag='Help users discover your place by creating a listing on Foodie Loverz' img={bookIcon} color='#FFFCF1' />
